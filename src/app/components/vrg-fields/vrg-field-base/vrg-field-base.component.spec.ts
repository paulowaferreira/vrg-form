...
describe(`${VrgFieldBaseComponent.name}`, () => {
  ...
  it('should handle value change', () => {
    ...
    component['elementRef'] = new ElementRef(null)
    control.setValue('test value')
    expect(component.isFilled).toBeTruthy()
  })

  it('should handle custom class input', () => {
    component.customNgClassInput = 'test-class'
    component['ngClassInput'] = {}
    component.handleCustomClassInput()
    expect(component['ngClassInput']['test-class']).toBeTruthy()
  })
